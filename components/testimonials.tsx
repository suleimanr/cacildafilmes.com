...
const testimonials = [
  {
    ...
    content:
      "A Punch Conteúdo transformou nossa abordagem de treinamento corporativo. O conteúdo é envolvente e os resultados são impressionantes!",
  },
  {
    id: 2,
    name: "João Santos",
    ...
    content:
      "A criatividade e a qualidade do material produzido pela Punch Conteúdo elevaram significativamente o engajamento de nossa equipe nos treinamentos.",
  },
  {
    id: 3,
    name: "Ana Oliveira",
    company: "Inova Saúde",
    content:
      "Estamos extremamente satisfeitos com a parceria com a Punch Conteúdo. Seus treinamentos sob medida fizeram toda a diferença em nossa organização.",
  },
]
